...
def main():
    ...
    figure_filename = f"models/{MODEL_TYPE}/figures/{MODEL_TYPE}_{sanitize_file_string(ENV_NAME)}_lr{LEARNING_RATE}_gamma{GAMMA}_eps{EPSILON}_{datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}.png"
    ...
    plot_learning_curve(steps_array, scores, eps_history, filename=figure_filename)
